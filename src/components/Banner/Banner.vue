            ...
            <div class="row">
                <div class="col-xl-6 col-md-12" data-aos="zoom-in" data-aos-duration="800">
                    <div class="banner-top__content">
                        <div class="sale-top">
                            <router-link to="#">75% SAVE</router-link>
                        ...
                        <div class="button">
                            <router-link class="btn-action style-1" to="/sign-up"><span>REGISTER & BUY TOKEN NOW</span><span class="icon-arrow"></span></router-link>
                        </div>
                    </div>
                </div>
